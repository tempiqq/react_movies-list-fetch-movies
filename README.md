...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://tempiqq.github.io/react_movies-list-fetch-movies/) and add it to the PR description.
